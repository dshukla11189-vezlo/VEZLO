...
from routes.maintenance import router as maintenance_router  # TEMPORARY - DELETE AFTER USE
...
app.include_router(maintenance_router, prefix="/api")  # TEMPORARY maintenance endpoint - DELETE AFTER USE
