"""
Retailer Orders, Rejections, Wastage, Payments, and Invoice Routes
"""
from fastapi import APIRouter, HTTPException, Depends
from fastapi.responses import StreamingResponse
from dependencies import db, get_current_user
from models import (
    RetailerOrder, RetailerOrderCreate, OrderStatusUpdate,
...
router = APIRouter(prefix="/api", tags=["retailer_orders"])
