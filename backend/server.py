...
@api_router.put("/retail-plans/{plan_id}")
...
@api_router.delete("/retail-plans/{plan_id}")
...
@api_router.post("/retail-plans/{plan_id}/products")
...
@api_router.put("/retail-plans/{plan_id}/products/{product_id}/{variant_id}")
...
@api_router.delete("/retail-plans/{plan_id}/products/{product_id}/{variant_id}")
...
@api_router.post("/retail-plans/assign")
...
@api_router.delete("/retail-plans/unassign/{retailer_id}")
...
@api_router.get("/retail-plans/subscribed-retailers")
...
@api_router.post("/retail-plans/generate-orders")
...
@api_router.get("/retailer-payment-ledger")
